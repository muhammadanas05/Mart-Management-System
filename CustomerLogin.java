...
public class CustomerLogin extends JFrame implements ActionListener {
    ...
    public CustomerLogin(String finalName) {
        ...
        // // categoryField.setForeground(Col or.gray);
        ...
        // String categories[] = { "Cosmetics", "Dairy", "Kids", "Clothing", "Food",
        // "Toy", "Drink", "Gadgets " };
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == back) {
            ...
            new cartpage(finalName);
            this.dispose();
        } else if (e.getSource() == Update) {
            credentials c3 = new credentials(finalName);
