...
public class Myframe extends JFrame implements ActionListener {
    ...
    Myframe() {
        ...
        label.setFont(new FontUIResource("MV Boli", Font.BOLD, 40));
        welcomeLabel.setFont(new FontUIResource("MV Boli", Font.BOLD, 40));
        ...
        loginfield = new JTextField("Anas");
    ...
    public void actionPerformed(ActionEvent e) {
        if ((e.getSource() == Loginbutton)) {
            if ((Role_combobox.getSelectedItem() == "Seller")) {
                ...
                credentials c2 = new credentials(x);
                try {
                ...
                credentials c2 = new credentials(u_name);
                try {
                    boolean result = c2.verify(u_name, pass);
                    if (result == true) {
                        JOptionPane.showMessageDialog(null, "Login Successfull !", "Access Granted",
                                JOptionPane.INFORMATION_MESSAGE);
                        new CustomerLogin(u_name);
                        this.dispose();
                    } else {
                        JOptionPane.showMessageDialog(null, "Incorrect Username or Password", "Access Denied",
                                JOptionPane.ERROR_MESSAGE);
